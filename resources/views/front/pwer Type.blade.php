...
@section('content')    <meta charset="utf-8">
    <title>Renewable Energy Technology</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Renewable Energy Technology Department – New Cairo Technological University</h1>
...
<div class="container mt-5 position-relative">
    <div class="card shadow-lg border-0 rounded-4 overflow-hidden wow fadeInUp"
        ...
        <video class="w-100"
            ...
            <source src="{{ asset('img/power Type.mp4') }}" type="video/mp4">
...
<!-- Hero Video Card End -->
    ...
    <div class="container my-5">
        ...
        <div class="custom-card">
            <h4 class="custom-title">Renewable Energy Technology</h4>
            <p class="custom-text">
                Under construction
        </div>
