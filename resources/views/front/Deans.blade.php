...
@endpush
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown"> NCTU Deans</h1>
    ...
    <section class="president-section">
        ...
        <div class="president-card">
            ...
            <br>
            <p>We are delighted to welcome you to the Faculty of Applied Health Sciences Technology,
