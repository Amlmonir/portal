        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="{{ url('Departments') }}">Courses</a>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6 gallery">
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                             <a href="{{ url('Departments') }}"><img class="img-fluid bg-light p-1" src="{{ asset('img/Departments/information technology.jpg') }}" alt="infotech"></a>
                        </div>
                        <div class="col-4">
                            <a href="{{ url('Departments') }}"><img class="img-fluid bg-light p-1" src="{{ asset('img/Departments/Mechatronic.jpg') }}" alt="Mecha"></a>
                        </div>
                        <div class="col-4">
                            <a href="{{ url('Departments') }}"><img class="img-fluid bg-light p-1" src="{{ asset('img/Departments/Autotronics.jpg') }}" alt="Auto"></a>
                        </div>
                        <div class="col-4">
                            <a href="{{ url('Departments') }}"><img class="img-fluid bg-light p-1" src="{{ asset('img/Departments/Petroleum engineering.jpg') }}" alt="petroleum"></a>
                        </div>
                        <div class="col-4">
                            <a href="{{ url('Departments') }}"><img class="img-fluid bg-light p-1" src="{{ asset('img/Departments/Prosthetics.jpg') }}" alt="Prosthetic"></a>
                        </div>
                        <div class="col-4">
                            <a href="{{ url('Departments') }}"><img class="img-fluid bg-light p-1" src="{{ asset('img/Departments/Renewable energy.jpg') }}" alt="energy"></a>
                        </div>
                    </div>
                </div>
